    ...
    <Row type="flex" justify="center" align="middle" style="width: 100%; height: 100%;">
        ...
        <Row style="width: 80%; max-width: 25rem; height: 21rem; z-index: 20;">
            ...
            <Row type="flex" justify="center" align="middle"
                ...
                <Form ref="passport" :model="passport" :rules="passport.rules" :label-width="50" style="width: 90%;">
                    ...
                    <FormItem label="验证码" prop="verifyCode" v-if="passport.requireVerify">
                        <Col span="15">
                        <Input v-model="passport.verifyCode" type="text" placeholder="请输入验证码..."/>
                        </Col>
                        <Col span="8" offset="1" style="margin-top: 1px">
                        <div style="width: 100%; height: 2rem; background-color: rebeccapurple;"></div>
                        </Col>
                    </FormItem>
...
<script>
  import "particles.js";
  import ParticleConfig from "@/tiny/configure/particles.json";
