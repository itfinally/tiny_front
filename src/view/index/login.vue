...
<script>
  ...
  import { authentication } from "@/rest/client";
  import { REQUEST_ADDRESS } from "@/tools/constant";

  import "particles.js";
  import { CoreUtils, StringUtils } from "jcdt";
  ...
  export default {
    ...
    methods: {
      ...
      getImage() {
        ...
        loginForm.validImage = StringUtils.format( `${REQUEST_ADDRESS}/verifies/get_valid_image/\${account}/\${random}`, {
